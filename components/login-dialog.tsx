        ...
        <form onSubmit={handleLogin} className="grid gap-4 py-4" noValidate>
          ...
          <div className="w-full">
            <Button
              ...
              type="button"
              name="google-login"
              className="w-full bg-white hover:bg-gray-50 text-gray-700 border-2 border-gray-300 flex items-center justify-center gap-3 py-3 px-4 font-medium text-base h-auto min-h-[48px]"
              style={{ display: 'flex' }}
            >
